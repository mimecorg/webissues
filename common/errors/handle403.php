...
class Common_Errors_Handle403 extends System_Web_Component
{
    ...
    protected function execute()
    {
        ...
        $this->view->setSlot( 'page_title', $this->t( 'title.AccessForbidden' ) );
        ...
        if ( System_Core_Application::getInstance()->isLoggingEnabled() ) {
            ...
            if ( $url != null ) {
                ...
                $eventLog->addEvent( System_Api_EventLog::Access, System_Api_EventLog::Error, $eventLog->t( 'log.AccessForbidden', array( $url ) ) );
            }
        }
    }
}
