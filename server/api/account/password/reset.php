...
class Server_Api_Account_Password_Reset
{
    public $access = '*';
    ...
    public function run()
    {
        ...
        $reset = array( 'user_login' => $user[ 'user_login' ], 'user_name' => $user[ 'user_name' ], 'user_email' => $email, 'reset_key' => $key );
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Account_Password_Reset' );
