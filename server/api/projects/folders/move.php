...
class Server_Api_Projects_Folders_Move
{
    public $access = '*';
    ...
    public function run( $folderId, $projectId )
    {
        ...
        $changed = $projectManager->moveFolder( $folder, $project );
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Projects_Folders_Move' );
