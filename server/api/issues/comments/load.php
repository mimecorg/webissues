...
class Server_Api_Issues_Comments_Load
{
    public $access = '*';
    ...
    public function run( $issueId, $commentId, $access )
    {
        $flags = 0;
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Issues_Comments_Load' );
