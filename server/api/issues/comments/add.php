...
class Server_Api_Issues_Comments_Add
{
    public $access = '*';
    ...
    public function run( $issueId, $commentText, $commentFormat )
    {
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Issues_Comments_Add' );
