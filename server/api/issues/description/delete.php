...
class Server_Api_Issues_Description_Delete
{
    public $access = '*';
    ...
    public function run( $issueId )
    {
        ...
        $stampId = $issueManager->deleteDescription( $description );
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Issues_Description_Delete' );
