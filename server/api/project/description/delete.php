...
class Server_Api_Project_Description_Delete
{
    public function run( $arguments )
    {
        ...
        $stampId = $projectManager->deleteProjectDescription( $description );
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Project_Description_Delete' );
