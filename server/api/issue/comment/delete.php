...
class Server_Api_Issue_Comment_Delete
{
    public function run( $arguments )
    {
        ...
        $stampId = $issueManager->deleteComment( $comment );
...
System_Bootstrap::run( 'Server_Api_Application', 'Server_Api_Issue_Comment_Delete' );
