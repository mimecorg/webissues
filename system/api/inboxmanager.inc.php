    ...
    */
    public function getInboxes()
    {
        $query = 'SELECT inbox_id, inbox_engine, inbox_email, inbox_server, inbox_port, inbox_encryption, inbox_user, inbox_password, inbox_mailbox, inbox_no_validate,'
            . ' inbox_leave_messages, inbox_allow_external, inbox_robot, inbox_map_folder, inbox_default_folder, inbox_respond, inbox_subscribe, inbox_format, inbox_use_oauth'
            . ' FROM {email_inboxes}';
    ...
    public function addInbox( $inbox )
    {
        ...
        try {
            ...
            $query = 'INSERT INTO {email_inboxes} ( inbox_engine, inbox_email, inbox_server, inbox_port, inbox_encryption, inbox_user, inbox_password, inbox_mailbox,'
                . ' inbox_no_validate, inbox_use_oauth, inbox_leave_messages, inbox_allow_external, inbox_robot, inbox_map_folder, inbox_default_folder, inbox_respond,'
                . ' inbox_subscribe, inbox_format )'
                . ' VALUES ( %s, %s, %s, %d, %s?, %s?, %s?, %s?, %d, %d, %d, %d, %d?, %d, %d?, %d, %d, %d )';
            ...
            $this->connection->execute( $query, $inbox[ 'inbox_engine' ], $inbox[ 'inbox_email' ], $inbox[ 'inbox_server' ], $inbox[ 'inbox_port' ],
                ...
                $inbox[ 'inbox_use_oauth' ], $inbox[ 'inbox_leave_messages' ], $inbox[ 'inbox_allow_external' ], $inbox[ 'inbox_robot' ], $inbox[ 'inbox_map_folder' ],
    ...
    public function modifyInbox( $inbox, $newInbox )
    {
        ...
        try {
            ...
            $query = 'UPDATE {email_inboxes}'
                ...
                . ' inbox_mailbox = %s!, inbox_no_validate = %d, inbox_use_oauth = %d, inbox_leave_messages = %d, inbox_allow_external = %d, inbox_robot = %d!,'
                . ' inbox_map_folder = %d, inbox_default_folder = %d!, inbox_respond = %d, inbox_subscribe = %d, inbox_format = %d'
                . ' WHERE inbox_id = %d';
            ...
            $this->connection->execute( $query, $newInbox[ 'inbox_engine' ], $newInbox[ 'inbox_email' ], $newInbox[ 'inbox_server' ], $newInbox[ 'inbox_port' ],
                ...
                $newInbox[ 'inbox_use_oauth' ], $newInbox[ 'inbox_leave_messages' ], $newInbox[ 'inbox_allow_external' ], $newInbox[ 'inbox_robot' ],
                $newInbox[ 'inbox_map_folder' ], $newInbox[ 'inbox_default_folder' ], $newInbox[ 'inbox_respond' ], $newInbox[ 'inbox_subscribe' ],
                $newInbox[ 'inbox_format' ], $inboxId );
