...
<template>
  <div class="container-fluid">
    ...
    <div class="radio">
      <label><input ref="regularRadio" type="radio" v-model="publicValue" v-bind:value="false"> {{ $t( 'EditProjectAccess.RegularProject' ) }}</label>
    </div>
    <div class="radio">
      <label><input ref="publicRadio" type="radio" v-model="publicValue" v-bind:value="true"> {{ $t( 'EditProjectAccess.PublicProject' ) }}</label>
    </div>
